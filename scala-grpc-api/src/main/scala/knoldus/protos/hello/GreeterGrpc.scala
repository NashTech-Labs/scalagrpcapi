...
object GreeterGrpc {
  val METHOD_SAY_HELLO: _root_.io.grpc.MethodDescriptor[knoldus.protos.hello.HelloRequest, knoldus.protos.hello.HelloReply] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      .setType(_root_.io.grpc.MethodDescriptor.MethodType.UNARY)
      .setFullMethodName(_root_.io.grpc.MethodDescriptor.generateFullMethodName("knoldus.protos.Greeter", "SayHello"))
      .setSampledToLocalTracing(true)
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[knoldus.protos.hello.HelloRequest])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[knoldus.protos.hello.HelloReply])
      .build()
  
  val SERVICE: _root_.io.grpc.ServiceDescriptor =
    _root_.io.grpc.ServiceDescriptor.newBuilder("knoldus.protos.Greeter")
      .setSchemaDescriptor(new _root_.scalapb.grpc.ConcreteProtoFileDescriptorSupplier(knoldus.protos.hello.HelloProto.javaDescriptor))
      .addMethod(METHOD_SAY_HELLO)
      .build()
  
  trait Greeter extends _root_.scalapb.grpc.AbstractService {
    override def serviceCompanion = Greeter
    def sayHello(request: knoldus.protos.hello.HelloRequest): scala.concurrent.Future[knoldus.protos.hello.HelloReply]
  }
  ...
  object Greeter extends _root_.scalapb.grpc.ServiceCompanion[Greeter] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.ServiceDescriptor = knoldus.protos.hello.HelloProto.javaDescriptor.getServices().get(0)
  }
  
  trait GreeterBlockingClient {
    def serviceCompanion = Greeter
    def sayHello(request: knoldus.protos.hello.HelloRequest): knoldus.protos.hello.HelloReply
  }
  ...
  class GreeterBlockingStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterBlockingStub](channel, options) with GreeterBlockingClient {
    override def sayHello(request: knoldus.protos.hello.HelloRequest): knoldus.protos.hello.HelloReply = {
  ...
  class GreeterStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterStub](channel, options) with Greeter {
    override def sayHello(request: knoldus.protos.hello.HelloRequest): scala.concurrent.Future[knoldus.protos.hello.HelloReply] = {
  ...
  def bindService(serviceImpl: Greeter, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
    ...
    .addMethod(
      METHOD_SAY_HELLO,
      _root_.io.grpc.stub.ServerCalls.asyncUnaryCall(new _root_.io.grpc.stub.ServerCalls.UnaryMethod[knoldus.protos.hello.HelloRequest, knoldus.protos.hello.HelloReply] {
        override def invoke(request: knoldus.protos.hello.HelloRequest, observer: _root_.io.grpc.stub.StreamObserver[knoldus.protos.hello.HelloReply]): Unit =
